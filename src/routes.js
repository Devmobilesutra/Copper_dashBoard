...
import CategoryImage from './views/images/CategoryImage';
...
import Reports_reconciliation from './views/Reports/Reports_reconciliation';
...
const Routes = () => (
    <BrowserRouter>
        <Switch>
            ...
            <Route path='/CategoryImage' component={CategoryImage}/>
            ...
            <Route path='/Reports_reconciliation' component={Reports_reconciliation}/>
